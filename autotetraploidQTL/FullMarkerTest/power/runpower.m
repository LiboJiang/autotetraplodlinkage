...
simutime=500;
savename=strcat('PowerResult',num2str(samplesize),'_',num2str(tval.h2*100));
...
scan.mk=0;scan.sideL=0;scan.sideR=-1;
  ...
  PowerResult(:,simu)=result1;
  save(savename,'PowerResult','samplesize','tval','LRerror');
