...
optionsEP=optimset('Algorithm','interior-point','DiffMinChange',1e-12,'MaxIter',20,'MaxFunEvals',5000,'Display','off');
...
simutime=500;
savename=strcat('PowerPermu',num2str(samplesize),'_',num2str(tval.h2*100));
...
fprintf('CPT_power Strat  Samplesize=%d   H2=%0.2f  Scan:%d---%d\n\n',samplesize,tval.h2,SetScan.start,SetScan.end)
...
scan.mk=0;scan.sideL=0;scan.sideR=-1;
  ...
  PowerPermu(:,simu)=result1;
  save(savename,'PowerPermu','samplesize','tval');
