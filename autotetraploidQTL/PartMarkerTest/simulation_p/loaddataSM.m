...
% Lphase(1).case='m23';
% Lphase(1).dms=[10,6];
% Lphase(1).configration=[1,2,3,4;1,2,3,3];
% Lphase(1).mtc{1,1}=1; Lphase(1).mtc{1,2}=2; Lphase(1).mtc{1,3}=3; Lphase(1).mtc{1,4}=4; Lphase(1).mtc{1,5}=5;
% Lphase(1).mtc{1,6}=6; Lphase(1).mtc{1,7}=7; Lphase(1).mtc{1,8}=8; Lphase(1).mtc{1,9}=9; Lphase(1).mtc{1,10}=10;    
% Lphase(1).mtc{2,1}=1; Lphase(1).mtc{2,2}=2; Lphase(1).mtc{2,3}=[3,9,10]; Lphase(1).mtc{2,4}=5; Lphase(1).mtc{2,5}=[6,7]; Lphase(1).mtc{2,6}=[8,9];
% %%% case m34 
% %%% 1 2 3 3
% %%% 1 2 3 4
% Lphase(2).case='m34';
% Lphase(2).dms=[6,10];
% Lphase(2).configration=[1,2,3,3;1,2,3,4];
% Lphase(2).mtc{1,1}=1; Lphase(2).mtc{1,2}=2; Lphase(2).mtc{1,3}=[3,4,10]; Lphase(2).mtc{1,4}=5; Lphase(2).mtc{1,5}=[6,7]; Lphase(2).mtc{1,6}=[8,9];
% Lphase(2).mtc{2,1}=1; Lphase(2).mtc{2,2}=2; Lphase(2).mtc{2,3}=3; Lphase(2).mtc{2,4}=4; Lphase(2).mtc{2,5}=5;
% Lphase(2).mtc{2,6}=6; Lphase(2).mtc{2,7}=7; Lphase(2).mtc{2,8}=8; Lphase(2).mtc{2,9}=9; Lphase(2).mtc{2,10}=10;    
% 
% %%% case m45 
% %%% 1 2 3 4
% %%% 1 2 2 2
% Lphase(3).case='m45';
% Lphase(3).dms=[10,3];
% Lphase(2).configration=[1,2,3,4;1,2,2,2];
% Lphase(3).mtc{1,1}=1; Lphase(3).mtc{1,2}=2; Lphase(3).mtc{1,3}=3; Lphase(3).mtc{1,4}=4; Lphase(3).mtc{1,5}=5;
% Lphase(3).mtc{1,6}=6; Lphase(3).mtc{1,7}=7; Lphase(3).mtc{1,8}=8; Lphase(3).mtc{1,9}=9; Lphase(3).mtc{1,10}=10;     
% Lphase(3).mtc{2,1}=1; Lphase(3).mtc{2,2}=[2,3,4,8,9,10]; Lphase(3).mtc{2,3}=[5,6,7]; 
% %%% case m56 
% %%% 1 2 2 2
% %%% 1 2 3 4
% Lphase(4).case='m56';
% Lphase(4).dms=[3,10];
% Lphase(4).configration=[1,2,2,2;1,2,3,4];
% Lphase(4).mtc{1,1}=1; Lphase(4).mtc{1,2}=[2,3,4,8,9,10]; Lphase(4).mtc{1,3}=[5,6,7];  
% Lphase(4).mtc{2,1}=1; Lphase(4).mtc{2,2}=2; Lphase(4).mtc{2,3}=3; Lphase(4).mtc{2,4}=4; Lphase(4).mtc{2,5}=5;
% Lphase(4).mtc{2,6}=6; Lphase(4).mtc{2,7}=7; Lphase(4).mtc{2,8}=8; Lphase(4).mtc{2,9}=9; Lphase(4).mtc{2,10}=10;    
% 
