...
simutime=500;
savename=strcat('FPR_p',num2str(samplesize));
...
%     eval.u=tval.u;eval.sigma2=tval.sigma2;
  ...
  fprintf('FPRsimu/scan %d/%.1f    Max LR=%.2f\n\n',simu,result1);
   
  FPRResult(:,simu)=result1;
  save(savename,'FPRResult','samplesize','tval');
