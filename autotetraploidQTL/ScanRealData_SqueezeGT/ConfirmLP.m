...
fprintf('LinkagePhase:[%s]  Likelihood=%f  epai: %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f %4.3f \n',Lphase(ilp).case,LphasePar(ilp).likelihood,epai(1),epai(2),epai(3),epai(4),epai(5),epai(6),epai(7),epai(8),epai(9));
