...
%%% 1 0 0 0
%%% 1 0 0 0
Lphase(1).case=1; %%%'1000*1000';
Lphase(1).dms=[2,2];
Lphase(1).configration=[1,0,0,0;1,0,0,0];
Lphase(1).mtc{1,1}=[2,3,4,8,9,10]; Lphase(1).mtc{1,2}=[1,5,6,7];
Lphase(1).mtc{2,1}=[2,3,4,8,9,10]; Lphase(1).mtc{2,2}=[1,5,6,7]; 
%%% case m1000*0100 
%%% 1 0 0 0
%%% 0 1 0 0
Lphase(2).case=2; %%%'1000*0100';
Lphase(2).dms=[2,2];
Lphase(2).configration=[1,0,0,0;0,1,0,0];
Lphase(2).mtc{1,1}=[2,3,4,8,9,10]; Lphase(2).mtc{1,2}=[1,5,6,7]; 
Lphase(2).mtc{2,1}=[1,3,4,6,7,10]; Lphase(2).mtc{2,2}=[2,5,8,9];
